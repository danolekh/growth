/**
 * growth — the always-on half of Dan's job hunt, as one Alchemy Worker.
 *
...
import { makeRepo } from "./src/Db.ts";
import type { Deps, Kv, Settings } from "./src/Deps.ts";
import { ingestMail, parseMail } from "./src/EmailIngest.ts";
import { makeTelegram } from "./src/Telegram.ts";
