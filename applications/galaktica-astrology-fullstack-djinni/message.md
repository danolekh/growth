...
**Наскільки ви занурені в астрологію — західну чи ведичну? На якому проєкті імплементували?**

Чесно - ні, астрологію я не вивчав, ні західну, ні ведичну, і проєкту в цьому домені в мене не
було. Те, що я маю - це досвід з боку інженерії, яка близька до вашої задачі: на Quextro я сам
спроєктував і зробив LLM-пайплайн, що перетворює неструктуровані дані (PDF екзаменаційних робіт) у
чіткі, відтворювані структуровані результати. На останньому контракті я писав продакшн-логіку
навколо грошей на iGaming-платформі - ідемпотентні виведення коштів, списання бонусів одним
statement - де точність і відтворюваність результату так само критичні, як у розрахунковому ядрі,
що описаний у вас. Домен готовий вивчати через документацію та роботу з вашими доменними
експертами, як і написано в пості.
