# Djinni application — CML Team

English post, worldwide agency bench listing.
...
a custom admin panel for 2,000+ products. I built Quextro solo before that, including an LLM
pipeline that extracts questions and topics from PDF exam papers.

Honest gap: you're asking for 5+ years, I have 3. My production backend is Express, not NestJS,
though the architecture is close. I haven't used Kafka, RabbitMQ, Terraform or Kubernetes, and no
...
## Form settings
- **Salary expectations / rate:** $30-35/hr. They ask for hourly or daily rate directly rather
  than a monthly figure; matches the standard freelance hourly ask.
- **CV:** `me/resume/out/Resume-backend.pdf`
- **Timing:** posted today, 14 applications so far. Send soon.
